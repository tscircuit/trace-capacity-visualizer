...
import initialPathingSolver from "../../test-assets/bug-1/initial_pathing_solver_input.json"
import pathingOptimizerInput from "../../test-assets/bug-1/pathingOptimizer_input.json"
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div style={{ marginBottom: 16, color: "#6b7280", fontSize: 14 }}>
        ...
        Enable "Path Debug" and select connections to highlight start/end points (gold) and paths.
      </div>
